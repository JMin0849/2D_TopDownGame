...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        //Box: 3000, Desk: 4000
        talkData.Add(1000, new string[] {"안녕?:0", "이 곳에 처음 왔니??:1"});
        talkData.Add(2000, new string[] {"?!!...?: 2", "너 누...누구야?!?: 3"});

        talkData.Add(3000, new string[] {"평범한 나무상자다."});
        talkData.Add(4000, new string[] {"이 책상에 낙서내용이 심상치 않다.."});
        ...
        talkData.Add(20 + 1000, new string[]{ "루도의 동전?:1",
                                              "돈을 흘리고 다니면 못쓰지!:3",
                                              "나중에 루도에게 한마디 해야겠어.:3"});
        talkData.Add(20 + 2000, new string[] {"찾으면 꼭 좀 가줘다 줘.:1",});                                                                    
